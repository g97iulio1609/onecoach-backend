    ...
    for (let i = 1; i <= str2.length; i++) {
        for (let j = 1; j <= str1.length; j++) {
            ...
            if (str2.charAt(i - 1) === str1.charAt(j - 1)) {
                ...
                currRow[j] = Math.min(prevCell + 1, // substitution
...
export class FoodMatchingService {
     ...
     */
    static async findOrCreateFood(extractedData) {
        // 1. Match esatto
     ...
     */
    static async findOrCreateMultipleFoods(extractedItems) {
