...
// Store
// ============================================================================
export const useChatStore = create()(devtools(subscribeWithSelector((set, get) => ({
    ...initialState,
    // === Initialization ===
    initialize: (userId) => {
...
export const selectCurrentConversationId = (state) => state.currentConversationId;
...
export const selectHasActiveConversation = (state) => state.currentConversationId !== null;
/** Selettore per la conversazione corrente (oggetto completo) */
export const selectCurrentConversation = (state) => state.currentConversationId
    ? state.conversations.find((c) => c.id === state.currentConversationId)
    : null;
/** Selettore per verificare se ci sono conversazioni */
export const selectHasConversations = (state) => state.conversations.length > 0;
/** Selettore per il conteggio delle conversazioni */
export const selectConversationsCount = (state) => state.conversations.length;
/** Selettore per il conteggio dei messaggi nella conversazione corrente */
export const selectMessageCount = (state) => state.messages.length;
// ============================================================================
