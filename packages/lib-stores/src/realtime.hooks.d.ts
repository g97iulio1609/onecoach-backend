 ...
 */
export declare function useRealtimeListSync<T extends {
    id: string | number;
}>({ table, queryKey, queryClient, filter, enabled, transform, onError, onSynced, }: UseRealtimeListSyncOptions<T>): void;
/**
 * @deprecated Use useRealtimeListSync instead
 */
export declare const useRealtimeSyncWithClient: typeof useRealtimeListSync;
