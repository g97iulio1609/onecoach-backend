...
export declare const projectsApi: {
    ...
    update: (id: string, input: Partial<CreateProjectInput>) => Promise<{
        project: Project;
    }>;
...
export declare const tasksApi: {
    ...
    update: (id: string, input: Partial<CreateTaskInput>) => Promise<{
        task: unknown;
    }>;
    delete: (id: string) => Promise<void>;
    reorder: (updates: {
...
export declare const milestonesApi: {
    ...
    update: (id: string, input: Partial<CreateMilestoneInput>) => Promise<{
        milestone: unknown;
    }>;
    delete: (id: string) => Promise<void>;
};
