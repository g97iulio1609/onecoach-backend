 ...
 */
export declare function useExercises<T extends Exercise = Exercise>(params?: ExerciseListParams, initialData?: ExercisesResponse<T>): import("@tanstack/react-query").UseQueryResult<ExercisesResponse<Exercise>, Error>;
/**
