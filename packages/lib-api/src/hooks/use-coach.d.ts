 ...
 */
import { type CoachDashboardPlansFilters, type CoachClientsFilters, type MarketplacePlanCardProps } from '../queries/coach.queries';
 ...
 */
export declare function useCoachDashboardPlans(filters?: CoachDashboardPlansFilters): import("@tanstack/react-query").UseQueryResult<import("../queries/coach.queries").CoachDashboardPlansResponse, Error>;
/**
