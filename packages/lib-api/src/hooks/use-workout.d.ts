 ...
 */
export declare function useWorkoutSession(sessionId: string | null | undefined): import("@tanstack/react-query").UseQueryResult<{
    session: unknown;
}, Error>;
/**
 ...
 */
export declare function useDeleteWorkout(): import("@tanstack/react-query").UseMutationResult<void, Error, string, unknown>;
/**
