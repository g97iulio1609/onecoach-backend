 ...
 */
export declare function useNutritionPlanVersions(id: string | null | undefined): import("@tanstack/react-query").UseQueryResult<{
    versions: unknown[];
}, Error>;
/**
 * Hook to get a nutrition day log by ID
 */
export declare function useNutritionDayLog(logId: string | null | undefined): import("@tanstack/react-query").UseQueryResult<{
    log: unknown;
}, Error>;
/**
 ...
 */
export declare function useDeleteNutritionPlan(): import("@tanstack/react-query").UseMutationResult<void, Error, string, unknown>;
/**
