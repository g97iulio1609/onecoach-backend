 ...
 */
export declare function useMarketplacePlans(filters?: MarketplaceFilters): import("@tanstack/react-query").UseQueryResult<import("../queries/marketplace.queries").MarketplacePlansResponse, Error>;
/**
 * Hook to get marketplace plans with infinite scroll
 */
export declare function useMarketplacePlansInfinite(filters?: MarketplaceFilters): import("@tanstack/react-query").UseInfiniteQueryResult<import("@tanstack/react-query").InfiniteData<import("../queries/marketplace.queries").MarketplacePlansResponse, unknown>, Error>;
/**
