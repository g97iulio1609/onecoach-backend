 ...
 */
export declare function useTasks(filters?: TasksFilters, enabled?: boolean): import("@tanstack/react-query").UseQueryResult<Task[], Error>;
/**
 * Hook to create task
 *
 ...
 */
export declare function useUpdateTaskStatus(): import("@tanstack/react-query").UseMutationResult<Task, Error, {
    id: string;
    status: TaskStatus;
}, {
 ...
 */
export declare function useGoals(filters?: GoalsFilters, enabled?: boolean): import("@tanstack/react-query").UseQueryResult<Goal[], Error>;
/**
 * Hook to create goal
 *
 * @returns Mutation result with create function
 */
export declare function useCreateGoal(): import("@tanstack/react-query").UseMutationResult<Goal, Error, Partial<Goal>, unknown>;
/**
 * Hook to delete goal
 *
 * @returns Mutation result with delete function
 ...
 */
export declare function useHabits(enabled?: boolean): import("@tanstack/react-query").UseQueryResult<unknown[], Error>;
/**
