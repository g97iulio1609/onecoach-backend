 ...
 */
export declare function useBodyMeasurements(filters?: BodyMeasurementsFilters): import("@tanstack/react-query").UseQueryResult<BodyMeasurement[], Error>;
/**
 ...
 */
export declare function useBodyMeasurement(id: string | undefined, enabled?: boolean): import("@tanstack/react-query").UseQueryResult<BodyMeasurement, Error>;
/**
 * Hook to create body measurement
 *
 * @returns Mutation result with create function
 */
export declare function useCreateBodyMeasurement(): import("@tanstack/react-query").UseMutationResult<BodyMeasurement, Error, CreateBodyMeasurementInput, {
 ...
 */
export declare function useUpdateBodyMeasurement(): import("@tanstack/react-query").UseMutationResult<BodyMeasurement, Error, {
    id: string;
 ...
 */
export declare function useDeleteBodyMeasurement(): import("@tanstack/react-query").UseMutationResult<void, Error, string, {
    previousMeasurements?: BodyMeasurement[];
