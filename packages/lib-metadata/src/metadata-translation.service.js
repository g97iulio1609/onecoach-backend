 ...
 */
export function getLocalizedName(entity, locale = DEFAULT_LOCALE) {
 ...
 */
export async function getExerciseTypesWithTranslations(locale) {
 ...
 */
export async function getMusclesWithTranslations(locale) {
    try {
 ...
 */
export async function getBodyPartsWithTranslations(locale) {
 ...
 */
export async function getEquipmentWithTranslations(locale) {
 ...
 */
export async function getWorkoutGoalsWithTranslations(locale) {
    try {
 ...
 */
export async function upsertExerciseTypeTranslation(exerciseTypeId, locale, name, description) {
 ...
 */
export async function upsertMuscleTranslation(muscleId, locale, name, description) {
 ...
 */
export async function upsertBodyPartTranslation(bodyPartId, locale, name, description) {
 ...
 */
export async function upsertEquipmentTranslation(equipmentId, locale, name, description) {
 ...
 */
export function isMetadataId(value, prefix) {
 ...
 */
export async function convertWorkoutGoalNamesToIds(values) {
 ...
 */
export async function getAllMetadataForLocale(locale = DEFAULT_LOCALE) {
    try {
