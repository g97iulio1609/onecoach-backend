...
function Devtools({ client }) {
    ...
    return _jsx(DevtoolsComponent, { initialIsOpen: false, client: queryClient });
}
/**
 ...
 * ```
 */
export function QueryProvider({ children, client, persist = false }) {
    ...
    return (_jsxs(QueryClientProvider, { client: queryClient, children: [children, _jsx(Devtools, { client: queryClient })] }));
}
