...
export declare function useOnboardingProgress(options?: {
    enabled?: boolean;
}): import("@tanstack/react-query").UseQueryResult<import("@onecoach/lib-stores").OnboardingProgress, Error>;
/**
 * Hook to complete a step
 */
export declare function useCompleteStep(): import("@tanstack/react-query").UseMutationResult<import("@onecoach/lib-stores").OnboardingProgress, Error, CompleteStepPayload, void>;
/**
 * Hook to skip a step
 */
export declare function useSkipStep(): {
    ...
    isPaused: boolean;
    submittedAt: number;
    mutateAsync: import("@tanstack/react-query").UseMutateAsyncFunction<import("@onecoach/lib-stores").OnboardingProgress, Error, CompleteStepPayload, void>;
    ...
    data: import("@onecoach/lib-stores").OnboardingProgress;
    error: null;
    variables: CompleteStepPayload;
    isError: false;
    isIdle: false;
 ...
 */
export declare function useGoToStep(): import("@tanstack/react-query").UseMutationResult<import("@onecoach/lib-stores").OnboardingProgress, Error, GoToStepPayload, void>;
/**
 * Hook to reset onboarding
 */
export declare function useResetOnboarding(): import("@tanstack/react-query").UseMutationResult<import("@onecoach/lib-stores").OnboardingProgress, Error, void, void>;
/**
 * Hook to complete all steps
 */
export declare function useCompleteAllSteps(): import("@tanstack/react-query").UseMutationResult<import("@onecoach/lib-stores").OnboardingProgress, Error, void, void>;
/**
