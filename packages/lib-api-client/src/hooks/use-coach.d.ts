 ...
 */
import { type CoachDashboardPlansFilters, type CoachClientsFilters } from '../queries/coach.queries';
/**
 ...
 */
export declare function useCoachDashboardStats(): import("@tanstack/react-query").UseQueryResult<any, Error>;
/**
 ...
 */
export declare function useCoachDashboardPlans(filters?: CoachDashboardPlansFilters): import("@tanstack/react-query").UseQueryResult<import("..").CoachDashboardPlansResponse, Error>;
/**
 ...
 */
export declare function useCoachClients(filters?: CoachClientsFilters): import("@tanstack/react-query").UseQueryResult<import("..").CoachClientsResponse, Error>;
