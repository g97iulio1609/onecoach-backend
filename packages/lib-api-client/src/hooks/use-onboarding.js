...
import { useOnboardingStore } from '@onecoach/lib-stores';
/**
...
export function useCompleteStep() {
    ...
    const setError = useOnboardingStore((state) => state.setError);
    return useMutation({
        mutationFn: (payload) => onboardingQueries.completeStep(payload),
        onMutate: () => {
...
export function useSkipStep() {
    ...
    return {
        mutate: (stepNumber) => mutate({ stepNumber, skipped: true }),
        ...rest,
    };
}
/**
...
export function useGoToStep() {
    ...
    const setError = useOnboardingStore((state) => state.setError);
    return useMutation({
        mutationFn: (payload) => onboardingQueries.goToStep(payload),
        onMutate: () => {
            setLoading(true);
            setError(null);
        },
