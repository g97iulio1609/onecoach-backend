...
import { directMessagingKeys, directMessagingQueries, directMessagingMutations, } from '../queries/direct-messaging.queries';
// ============================================================================
// Query Hooks
// ============================================================================
/**
 ...
 */
export function useDirectConversations(userId, role) {
    return useQuery({
 ...
 */
export function useDirectConversation(conversationId) {
    return useQuery({
 ...
 */
export function useDirectMessages(conversationId, page = 1, limit = 50) {
    return useQuery({
...
export function useUpdateConversationSettings() {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ conversationId, data }) => directMessagingMutations.updateConversationSettings(conversationId, data),
...
export function useSendDirectMessage() {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ conversationId, content, isImportant }) => directMessagingMutations.sendMessage(conversationId, { content, isImportant }),
        onSuccess: (_, variables) => {
...
export function useMarkMessageImportant() {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ messageId, isImportant }) => directMessagingMutations.markMessageImportant(messageId, isImportant),
        onSuccess: (_, variables) => {
            // Invalidate messages for this conversation
            queryClient.invalidateQueries({
                queryKey: directMessagingKeys.messages(variables.conversationId),
...
export function useReportMessage() {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ messageId, reason }) => directMessagingMutations.reportMessage(messageId, reason),
        onSuccess: (_, variables) => {
            // Invalidate messages for this conversation
            queryClient.invalidateQueries({
                queryKey: directMessagingKeys.messages(variables.conversationId),
