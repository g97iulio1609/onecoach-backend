...
import { coachKeys, coachQueries, } from '../queries/coach.queries';
/**
 ...
 */
export function usePublicCoachProfile(userId) {
    return useQuery({
 ...
 */
export function useCoachDashboardPlans(filters) {
    return useQuery({
 ...
 */
export function useCoachClients(filters) {
    return useQuery({
