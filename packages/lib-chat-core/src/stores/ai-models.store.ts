/**
 * AI Models Store (Local to lib-chat-core)
 *
 ...
 *
 * NOTE: This is a local copy for lib-chat-core to avoid cross-package import issues.
 * The main store is in @onecoach/lib-stores/ai-models.store.ts
 *
...
import type { AIModel } from '../types/unified-chat';
